      ...
      <div className="header">
        ...
        {courseDate >= currentDateStart ? (
          ...
          <span className="classFinished">
            {classData.date && `Class Completed on ${courseDate.toLocaleDateString()}`}
          </span>
        )}
      </div>
        ...
        {displayJoiningLink ? (
          <div className="joiningLinkWrapper">
            <div className="classLink">
              <a href={classData.classLink} target="_blank" rel="noopener noreferrer">
                Click here to join class
              </a>
              <div className="meetingInfo">
                <div>
                  In case of any difficulty using the above link, use the following credentials to join class:
                </div>
